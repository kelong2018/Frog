...
var WebGLRenderingContext = (function () {
    ...
    WebGLRenderingContext.prototype.bindBuffer = function (target, buffer) {
        ...
        conch.bf.wu32(this.id);
        conch.bf.wu32(2);
        conch.bf.wu16(target);
        conch.bf.wu16(buffer);
    };
    ...
    WebGLRenderingContext.prototype.shaderSource = function (shader, source) {
        ...
        conch.bf.wu32(this.id);
        conch.bf.wu32(6);
        conch.bf.wu16(shader);
        conch.bf.wstring(source, false);
    };
    ...
    WebGLRenderingContext.prototype.texImage2DEx = function (premultiplyAlpha, target, level, internalformat, width, height, border, format, type, pixels) {
        if (arguments.length == 10) {
            ...
            conch.bf.wu32(this.id);
            conch.bf.wu32(26);
            conch.bf.wu16(arguments[0 + 1]);
            conch.bf.wu16(arguments[1 + 1]);
            conch.bf.wu16(arguments[2 + 1]);
            conch.bf.wu16(arguments[3 + 1]);
            conch.bf.wu16(arguments[4 + 1]);
            conch.bf.wu16(arguments[5 + 1]);
            conch.bf.wu16(arguments[6 + 1]);
            conch.bf.wu16(arguments[7 + 1]);
    ...
    WebGLRenderingContext.prototype.scissor = function (x, y, width, height) {
        if (this.__priv_canvas._hasTransform) {
            var t = this.__priv_canvas._tranform;
            width *= t[0];
            height *= t[3];
            x = x * t[0] + t[4];
